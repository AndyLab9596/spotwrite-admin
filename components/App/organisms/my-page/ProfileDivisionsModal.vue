    ...
    <div class="modal-overlay" @click.self="onClose">
      <div class="modal-window">
        ...
        <div class="modal-contents">
          <p class="division-title">組織を選択</p>
          <div class="division-wrapper">
            <template v-for="item in divisions">
              <div
                ...
                class="division-item"
                :class="{
                  'selected-division-item': isSelectedDivision(item.uuid),
                }"
                @click="clickDivision(item.uuid)"
              >
                <p class="division-item-text">
                  {{ item.name }}
                </p>
              </div>
            </template>
...
export default Vue.extend({
  ...
  methods: {
    ...
    isSelectedDivision(uuid: string) {
      return this.selectedDivisionsUuids.includes(uuid);
    },
  },
});
</script>
