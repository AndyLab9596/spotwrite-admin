<template>
  <div class="management-profile-container">
    <ValidationObserver v-slot="{ handleSubmit, invalid }">
      ...
      >
        <validation-provider v-slot="name" rules="required" name="名称">
          <div class="input-box">
            <label class="label">名称<span class="required">※必須</span></label>
            <input
              id="name"
              v-model="input.name"
              type="text"
        ...
        <validation-provider v-slot="description" name="概要">
          <div class="textarea-box form-item">
            ...
            <base-textarea
              ...
              placeholder="経営陣についてまとめた文章を入力してください。"
            ></base-textarea>
          </div>
        ...
        <div class="select-box form-item">
          <label class="label">経営陣代表者</label>
          <v-select
        ...
        <div v-if="input.leader_uuid" class="textarea-box form-item">
          <label class="label">経営陣からメッセージ</label>
          <base-textarea
            v-model="input.message"
            class="textarea"
            placeholder="経営陣からのメッセージを入力してください。"
          ></base-textarea>
        </div>
