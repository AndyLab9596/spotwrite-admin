<template>
  <div class="scrollable-tabs">
    ...
    <div v-if="hasCompaniesExceeded" class="arrow-left" @click="scrollRight()">
      <div class="arrow-button">
        <img src="/icon/icon_go_left.svg" alt="" />
      </div>
    </div>
    <div v-if="hasCompaniesExceeded" class="arrow-right" @click="scrollLeft()">
      <div class="arrow-button">
