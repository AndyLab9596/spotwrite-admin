          ...
          <validation-observer v-slot="{ invalid, passes }">
            ...
            >
              <div class="flex mb-4">
                ...
                <div>
                  <select
                    id="difficulty"
                    v-model="newArticleTheme.difficulty_level"
                    class="select"
                    name="difficulty"
            ...
            >
              <div class="flex mb-4">
                ...
                <div>
                  <textarea
                    v-model="newArticleTheme.description"
            ...
            >
              <div class="flex mb-4">
                ...
                <div>
                  <textarea
                    v-model="newArticleTheme.sample_text"
                ...
                <div class="button-container">
                  <div class="add">
                    <base-button
                      ...
                      class="add-button"
                      :disabled="invalid"
                      @click="passes(createPostTheme(newArticleTheme))"
                    >
                      保存する
                    </base-button>
                  </div>
...
import { createAdminPostTheme } from '@/libs/api';
...
export default Vue.extend({
  ...
  methods: {
    ...
    async createPostTheme(newPostTheme: PostTheme) {
      if (
        !newPostTheme.title ||
        !newPostTheme.description ||
        !newPostTheme.difficulty_level ||
        !newPostTheme.sample_text
      ) {
        this.summaryError = '入力を確認してください。';
      } else {
        try {
          await createAdminPostTheme(newPostTheme);
        } catch (e) {
          throw new Error(e);
        } finally {
          this.summaryError = '';
