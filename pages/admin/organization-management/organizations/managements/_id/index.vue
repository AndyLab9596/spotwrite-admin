...
<script lang="ts">
import Vue from 'vue';
import { ManagementProfile, ScheduleAndData } from '@/components/Admin/Pages';
...
export default Vue.extend({
  ...
  async asyncData({ params, error }: { params: any; error: any }) {
    try {
      ...
      // ユーザー一覧取得
      const organizationUsers = await fetchOrganizationUsers(params.id);
  ...
  methods: {
    ...
    changeWorkFlows(workflows: Types.Workflow[]) {
